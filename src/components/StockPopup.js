    ...
    render() {
        return (
            ...
            <div style={{ padding: '0px',background:'transparent' }} className="row" >
              <div className="col-lg-9 col-md-9 col-sm-5 col-5" style={{ background:'transparent'}}>
                ...
                <h4 style={{ fontSize:'12pt',paddingTop:'10px',paddingBottom:'15px',paddingLeft: '15px', fontFamily: 'Muli', fontWeight: 600, textAlign: 'left' }}>{this.props.stock.companyName}</h4>

                <div className="col-lg-10 col-md-10 col-sm-12 col-12">
                  <div className="row">
                    <div className="col-lg-8 col-md-8 col-8">
                      <h5 style={{ paddingBottom: '20px', fontFamily: 'Muli', fontWeight: 600, textAlign: 'left' }}></h5>
              ...
              <div style={{ display: 'flex', float: 'left', paddingLeft: '0px' }} className="">
                      ...
                      <h1 style={{ paddingBottom: '10px', paddingTop: '12px', fontSize: '18pt', paddingLeft: '0px', fontFamily: 'Muli', fontWeight: 700, textAlign: 'left' }}>
